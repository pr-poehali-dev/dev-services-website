...
const faqCategories = [
  {
    ...
    questions: [
      ...
      },
      {
        ...
        a: 'Стоимость базового чат-бота с RAG начинается от 300 000 ₽, сложные мультиагентные системы — от 1 500 000 ₽. Точная оценка зависит от объема знаний, количества интеграций и требований к точности ответов.'
      }
    ]
  },
  {
